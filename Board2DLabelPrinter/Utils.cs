...
namespace Board2DLabelPrinter
{
    class Utils
    {
        ...
        static SqlConnectionStringBuilder _constr = new SqlConnectionStringBuilder(Board2DLabelPrinter.Properties.Settings.Default.DBConnectionString);
